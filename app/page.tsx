...
export default function Home() {
  ...
  return (
    ...
    <div className="relative">
      ...
      {/* Hero Content */}
      <div className="relative z-10 flex flex-col pt-20 md:pt-32 pb-24 md:pb-40 text-white px-6 md:px-20 items-center md:items-start justify-center w-full">
    ...
    <div className="relative z-20 flex flex-col items-center bg-lapd-primary justify-center py-10 w-full">
      <div className="max-w-6xl w-full px-6 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Link href="/qualifications" className="border-white border-[2px] civilan-menu-2-wrapper blue relative group overflow-hidden rounded-lg">
            <div className="grid-image-wrapper relative">
              <img
                src="https://cdn.prod.website-files.com/63db1d04e804176dcb525fc5/6434f2d366bed84cd9bec007_Graduation-Line.webp"
                className="grid-image w-full h-64 object-cover transform transition-transform duration-300 group-hover:scale-110"
              />
              ...
              <div className="grid-text-wrapper absolute inset-0 flex flex-col justify-end p-6 text-white">
                <div className="grid-title text-2xl font-semibold">NİTELİKLER</div>
                <div className="grid-text mt-2">Yaş, Eğitim, Vatandaşlık & Arka Plan Standartları</div>
              </div>
            </div>
          </Link>

          {/* Grid Item 2: Hiring Process */}
          <Link href="/hiring-process" className=" border-white border-[2px] civilan-menu-2-wrapper blue relative group overflow-hidden rounded-lg">
            <div className="grid-image-wrapper relative">
              <img
                src="https://cdn.prod.website-files.com/63db1d04e804176dcb525fc5/63dba894d8a7bcd05e80fb1c_Web-LAPD_WILSHIRE_-232.webp"
                className="grid-image w-full h-64 object-cover transform transition-transform duration-300 group-hover:scale-110"
              />
              <div className="grid-image-overlay absolute inset-0 bg-black bg-opacity-50 transition-opacity duration-300 group-hover:bg-opacity-70"></div>
              <div className="grid-text-wrapper absolute inset-0 flex flex-col justify-end p-6 text-white">
          ...
          <Link href="/diversity" className="border-white border-[2px] civilan-menu-2-wrapper blue relative group overflow-hidden rounded-lg">
            <div className="grid-image-wrapper relative">
              <img
                src="https://cdn.prod.website-files.com/63db1d04e804176dcb525fc5/63db8ba6ee84cd5c292a2e46_Web-CHO_3358.webp"
                className="grid-image w-full h-64 object-cover transform transition-transform duration-300 group-hover:scale-110"
              />
              <div className="grid-image-overlay absolute inset-0 bg-black bg-opacity-50 transition-opacity duration-300 group-hover:bg-opacity-70"></div>
              <div className="grid-text-wrapper absolute inset-0 flex flex-col justify-end p-6 text-white">
          ...
          {/* Grid Item 4: Salary & Benefits */}
          <Link href="/salary-and-benefits" className="border-white border-[2px] civilan-menu-2-wrapper blue relative group overflow-hidden rounded-lg">
            <div className="grid-image-wrapper relative">
              <img
                src="https://cdn.prod.website-files.com/63db1d04e804176dcb525fc5/63dba894d8a7bc18b880fb2a_PSLF-DebtForgive-Inset-Pic.webp"
                className="grid-image w-full h-64 object-cover transform transition-transform duration-300 group-hover:scale-110"
              />
              <div className="grid-image-overlay absolute inset-0 bg-black bg-opacity-50 transition-opacity duration-300 group-hover:bg-opacity-70"></div>
              <div className="grid-text-wrapper absolute inset-0 flex flex-col justify-end p-6 text-white">
                <div className="grid-title text-2xl font-semibold">MAAŞ & AVANTAJLAR</div>
                <div className="grid-text mt-2">LAPD Memurları Harika Avantajlardan Yararlanır</div>
              </div>
            </div>
          </Link>

          {/* Grid Item 5: Fast-Track */}
          <Link href="/fast-track" className="border-white border-[2px] civilan-menu-2-wrapper blue relative group overflow-hidden rounded-lg">
            <div className="grid-image-wrapper relative">
              <img
                src="https://cdn.prod.website-files.com/63db1d04e804176dcb525fc5/63dba894d8a7bc626b80fb21_top%20shelf%203.webp"
                className="grid-image w-full h-64 object-cover transform transition-transform duration-300 group-hover:scale-110"
              />
              <div className="grid-image-overlay absolute inset-0 bg-black bg-opacity-50 transition-opacity duration-300 group-hover:bg-opacity-70"></div>
              <div className="grid-text-wrapper absolute inset-0 flex flex-col justify-end p-6 text-white">
                <div className="grid-title text-2xl font-semibold">HIZLI İŞE ALIM</div>
                <div className="grid-text mt-2">LAPD Hızlı İşe Alım Süreci</div>
              </div>
            </div>
          </Link>

          {/* Grid Item 6: Careers */}
          <Link href="/careers" className="border-white border-[2px] civilan-menu-2-wrapper blue relative group overflow-hidden rounded-lg">
            <div className="grid-image-wrapper relative">
              <img
                src="https://cdn.prod.website-files.com/63db1d04e804176dcb525fc5/64353febaf57405d72adbfff_FAQ-Beach-Officers.webp"
                className="grid-image w-full h-64 object-cover transform transition-transform duration-300 group-hover:scale-110"
              />
              <div className="grid-image-overlay absolute inset-0 bg-black bg-opacity-50 transition-opacity duration-300 group-hover:bg-opacity-70"></div>
              <div className="grid-text-wrapper absolute inset-0 flex flex-col justify-end p-6 text-white">
